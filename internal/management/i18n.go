...
var catalogs = map[Lang]map[string]string{
	LangZhHant: {
		...
		"how_manual":             "手動",
		"how_manual_v":           "打完整白名單",
		"how_quota_removed":      "額度欄",
		"how_quota_removed_v":    "已從帳號卡移除",
	...
	LangEn: {
		...
		"how_quota_removed":      "Quota columns",
		"how_quota_removed_v":    "Removed from cards",
	...
	LangJa: {
		...
		"how_quota_removed":      "クォータ欄",
		"how_quota_removed_v":    "カードから削除済み",
