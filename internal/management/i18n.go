...
var catalogs = map[Lang]map[string]string{
	LangZhHant: {
		...
		"rail_model":         "模型",
		"rail_key":           "當次金鑰",
		"principles_title":   "操作原則",
		"principles_body":    "先勾帳號 → 儲存 → 立刻執行才會用到新名單。空白名單 = 誰都不打。",
		...
		"no_last_run":        "尚無執行紀錄",
		"run_history":        "歷史紀錄",
		"run_history_sub":    "由新到舊，受 history_limit 限制。",
		"col_result":         "結果",
		"col_http":           "HTTP",
		"col_detail":         "說明",
	...
	LangEn: {
		...
		"principles_body":    "Select → Save → Run now uses the saved list. Empty allowlist = ping nobody.",
		...
		"accounts":           "Accounts",
		"accounts_who_title":  "Who to ping",
		...
		"run_history_sub":    "Newest first; capped by history_limit.",
		"col_result":         "Result",
		"col_http":           "HTTP",
		"col_detail":         "Detail",
	...
	LangJa: {
		...
		"run_history":        "実行履歴",
		"run_history_sub":    "新しい順。history_limit まで保持します。",
		"col_result":         "結果",
		"col_http":           "HTTP",
		"col_detail":         "詳細",
